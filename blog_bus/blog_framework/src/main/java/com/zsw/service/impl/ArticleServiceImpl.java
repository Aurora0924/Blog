...
import com.zsw.mapper.ArticleMapper;
...
public class ArticleServiceImpl extends ServiceImpl<ArticleMapper, Article> implements ArticleService {
    ...
    public ResponseResult hostArticleList() {
        ...
        //必须是正式文章
        queryWrapper.eq(Article::getStatus, MessageConstant.ARTICLE_COMMENT);
        //按照浏览量进行排序
        ...
        List<HotArticleVo> vs = BeanCopyUtils.BeanCopyList(articles, HotArticleVo.class);
        return ResponseResult.SuccessResult(vs);
    }
    ...
    public ResponseResult articleList(Integer pageNum, Integer pageSize, Long categoryId) {
        ...
        // 状态是正式发布的
        lambdaQueryWrapper.eq(Article::getStatus,MessageConstant.ARTICLE_STATUS_NORMAL);
        // 对isTop进行降序
        ...
        //封装查询结果
        List<ArticleListVo> articleListVos = BeanCopyUtils.BeanCopyList(page.getRecords(), ArticleListVo.class);
    ...
    public ArticleVo getInfo(Long id) {
        ...
        ArticleVo articleVo = BeanCopyUtils.BeanCopy(article,ArticleVo.class);
