...
import com.zsw.entity.UserRole;
import com.zsw.enums.AppHttpCodeEnum;
import com.zsw.exception.SystemException;
import com.zsw.mapper.UserMapper;
import com.zsw.service.UserRoleService;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
    ...
    public ResponseResult register(User user) {
        ...
        if(!StringUtils.hasText(user.getEmail())){
            throw new SystemException(AppHttpCodeEnum.USER_EMAIL_NOT_NULL);
        }
    ...
    public ResponseResult selectUserPage(User user, Integer pageNum, Integer pageSize) {
        ...
        List<UserVo> userVoList = users.stream()
                .map(u -> BeanCopyUtils.BeanCopy(u, UserVo.class))
